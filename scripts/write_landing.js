...
function CompassSketch() {
  return (
    <svg viewBox="0 0 80 80" width="80" height="80" className="opacity-20" aria-hidden>
      <circle cx="40" cy="40" r="36" fill="none" stroke="var(--tv-navy)" strokeWidth="2"/>
      <circle cx="40" cy="40" r="3" fill="var(--tv-navy)"/>
      <polygon points="40,10 44,40 40,36 36,40" fill="var(--tv-orange)"/>
      <polygon points="40,70 36,40 40,44 44,40" fill="var(--tv-navy)"/>
      <line x1="40" y1="10" x2="40" y2="70" stroke="var(--tv-navy)" strokeWidth="1" strokeDasharray="3 2"/>
      <line x1="10" y1="40" x2="70" y2="40" stroke="var(--tv-navy)" strokeWidth="1" strokeDasharray="3 2"/>
      <text x="40" y="7" textAnchor="middle" fontSize="6" fill="var(--tv-navy)" fontFamily="Georgia,serif">N</text>
      <text x="40" y="77" textAnchor="middle" fontSize="6" fill="var(--tv-navy)" fontFamily="Georgia,serif">S</text>
      <text x="5" y="43" textAnchor="middle" fontSize="6" fill="var(--tv-navy)" fontFamily="Georgia,serif">W</text>
      <text x="75" y="43" textAnchor="middle" fontSize="6" fill="var(--tv-navy)" fontFamily="Georgia,serif">E</text>
    </svg>
  );
}
...
function OliveBranch() {
  return (
    <svg viewBox="0 0 120 60" width="120" height="60" className="opacity-25" aria-hidden>
      <path d="M10,50 Q30,20 60,15 Q90,10 110,5" fill="none" stroke="var(--tv-navy)" strokeWidth="1.5"/>
      <ellipse cx="35" cy="28" rx="8" ry="5" fill="none" stroke="var(--tv-navy)" strokeWidth="1.2" transform="rotate(-30 35 28)"/>
      <ellipse cx="55" cy="20" rx="8" ry="5" fill="none" stroke="var(--tv-navy)" strokeWidth="1.2" transform="rotate(-20 55 20)"/>
      <ellipse cx="75" cy="14" rx="7" ry="4" fill="none" stroke="var(--tv-navy)" strokeWidth="1.2" transform="rotate(-15 75 14)"/>
      <ellipse cx="93" cy="9"  rx="6" ry="4" fill="none" stroke="var(--tv-navy)" strokeWidth="1.2" transform="rotate(-10 93 9)"/>
    </svg>
  );
}
...
function NoteSketch() {
  return (
    <svg viewBox="0 0 48 48" width="48" height="48" aria-hidden>
      <rect x="8" y="6" width="32" height="36" rx="3" fill="none" stroke="var(--tv-navy)" strokeWidth="2"/>
      <line x1="14" y1="16" x2="34" y2="16" stroke="var(--tv-orange)" strokeWidth="1.5"/>
      <line x1="14" y1="22" x2="34" y2="22" stroke="var(--tv-navy)" strokeWidth="1.5"/>
      <line x1="14" y1="28" x2="26" y2="28" stroke="var(--tv-navy)" strokeWidth="1.5"/>
      <circle cx="36" cy="36" r="6" fill="var(--tv-orange)" opacity="0.8"/>
...
function CollabSketch() {
  return (
    <svg viewBox="0 0 48 48" width="48" height="48" aria-hidden>
      <circle cx="16" cy="18" r="7" fill="none" stroke="var(--tv-navy)" strokeWidth="2"/>
      <circle cx="32" cy="18" r="7" fill="none" stroke="var(--tv-orange)" strokeWidth="2"/>
      <path d="M4,38 Q16,28 16,28 Q24,32 32,28 Q44,38 44,38" fill="none" stroke="var(--tv-navy)" strokeWidth="2"/>
      <line x1="24" y1="12" x2="24" y2="34" stroke="var(--tv-orange-light)" strokeWidth="1" strokeDasharray="3 2"/>
    </svg>
  );
}
...
function MapSketch() {
  return (
    <svg viewBox="0 0 48 48" width="48" height="48" aria-hidden>
      <path d="M8,8 L18,12 L30,8 L40,12 L40,40 L30,36 L18,40 L8,36 Z" fill="none" stroke="var(--tv-navy)" strokeWidth="2"/>
      <line x1="18" y1="12" x2="18" y2="40" stroke="var(--tv-border)" strokeWidth="1"/>
      <line x1="30" y1="8"  x2="30" y2="36" stroke="var(--tv-border)" strokeWidth="1"/>
      <circle cx="22" cy="22" r="4" fill="none" stroke="var(--tv-orange)" strokeWidth="1.5"/>
      <line x1="22" y1="26" x2="22" y2="32" stroke="var(--tv-orange)" strokeWidth="1.5"/>
    </svg>
  );
}
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <SignInButton mode="modal">
            <button
              style={{ color: "var(--tv-navy)", fontFamily: "var(--font-body)" }}
          ...
          <SignUpButton mode="modal">
            <button
              style={{ background: "var(--tv-orange)", color: "#fff", fontFamily: "var(--font-body)" }}
          ...
          <div className="flex gap-4 justify-center mb-16 flex-wrap">
            ...
            <SignInButton mode="modal">
              <button
                ...
                style={{ border: "2px solid var(--tv-navy)", color: "var(--tv-navy)", fontFamily: "var(--font-body)", background: "transparent" }}
              >
                Sign in
              </button>
            </SignInButton>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((f) => (
              <div
                ...
                style={{ background: "#FDFAF4", border: "1.5px solid var(--tv-border)", borderRadius: "1.25rem" }}
              >
                {f.icon}
                <h3
      ...
      <section className="px-6 py-20 text-center" style={{ background: "var(--tv-navy)" }}>
        ...
        <SignUpButton mode="modal">
          <button
            ...
            style={{ background: "var(--tv-cream)", color: "var(--tv-navy)", fontFamily: "var(--font-body)" }}
          >
